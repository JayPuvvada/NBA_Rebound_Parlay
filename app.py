...
from src.data_loader import DataUnavailableError, NBADataLoader
...
def _reset_projection_source_tracking(date_loader):
    """Reset per-request provenance without imposing it on test/custom loaders."""
...
def predict():
    try:
        ...
        _reset_projection_source_tracking(date_loader)
